...
const VerticalBox = () => {
  return (
    <div className="vertical_box_container">
      <div className="vertical_box_imag">
        <img className="box_imag" src={imgBox} alt="home's key" />
      </div>
      <div className="vertical_box_details">
        <div className="vertical_box_detail_offer_title">
          <h5>Appartement 3 pièces Neuf</h5>
        </div>
        <div className="vertical_box_detail_review_price">
        ...
        <div className="vertical_box_detail_sale_rante_meubl">
          <div className="rante">A vendre</div>
        </div>
        <div className="vertical_box_detail_options">
